...
public class ScramblePinPreferenceController extends AbstractPreferenceController
    ...
    public void updateState(Preference preference) {
        int value = Settings.System.getInt(
                mContext.getContentResolver(), Settings.System.HASH_LOCKSCREEN_PIN_SCRAMBLE_LAYOUT, 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.System.putInt(
                mContext.getContentResolver(), Settings.System.HASH_LOCKSCREEN_PIN_SCRAMBLE_LAYOUT, value ? 1 : 0);
        return true;
    }
