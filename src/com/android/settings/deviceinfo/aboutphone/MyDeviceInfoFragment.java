...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    private static final String KEY_HASH_INFO_HEADER = "hash_mod_header";
    private static final String PROPERTY_HASH_VERSION = "ro.hash.version";
    ...
    private void initHashHeader() {
        final LayoutPreference headerPreference =
                (LayoutPreference) getPreferenceScreen().findPreference(KEY_HASH_INFO_HEADER);
        final View appSnippet = headerPreference.findViewById(R.id.entity_header);
        final Activity context = getActivity();
        final Bundle bundle = getArguments();
        EntityHeaderController controller = EntityHeaderController
